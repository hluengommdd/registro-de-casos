...
function Seccion({ titulo, descripcion, items, navigate, tone, compact = false }) {
    ...
    >
      ...
      <div className="grid grid-cols-1 xl:grid-cols-2 gap-4">
        {items.map((s) => {
          ...
          const estudiante = s._supabaseData?.estudiante || null;
          const estudianteName = getStudentName(estudiante, 'Estudiante');
          const curso =
            s._supabaseData?.course || s.fields?.Curso_Incidente || null;
