...
function Seccion({
  ...
  return (
    <section
      className={`glass-panel p-6 ${styles.wrapper_bg} border border-white/50 shadow-glass`}
    >
      ...
      <div className="grid grid-cols-1 xl:grid-cols-2 gap-4">
        {items.map((s) => {
          ...
          const createdAt =
            caso?._supabaseData?.created_at || caso?.fields?.Fecha_Creacion;
          ...
          return (
            ...
            >
              ...
              <div
                className={`absolute left-0 top-0 bottom-0 w-1 ${tone === 'red' ? 'bg-red-500' : tone === 'purple' ? 'bg-violet-500' : 'bg-emerald-500'}`}
              />
