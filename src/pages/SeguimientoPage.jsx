...
import { createFollowup, getCaseDetails, getInvolucrados, updateCase } from '../api/db';
...
export default function SeguimientoPage({
  ...
  const grouped = useMemo(() => {
    ...
    // Orden cronolÃ³gico dentro de etapa
  ...
  const completedStageKeys = useMemo(() => {
    ...
    for (const s of seguimientos || []) {
      ...
      if (stage && status === 'Completada') set.add(stage);
    }
  ...
  return (
    <div className="h-full w-full">
                  ...
                  {isOpen && (
                    <div className="px-4 pb-4 space-y-3">
                      ...
                      {!readOnly && (
                        ...
                        >
                          + Registrar AcciÃ³n en esta etapa
                        </button>
                      )}
      ...
      {!readOnly && stageToAdd && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/40 p-4" role="dialog" aria-modal="true" aria-label="Registrar acción">
