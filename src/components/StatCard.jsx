    ...
    >
      <div className="flex items-start justify-between">
        <div>
          ...
          {subtitle && (
            <p className="text-[12px] text-slate-500 mt-1 font-medium">{subtitle}</p>
          )}
        </div>
        <div className={`p-3 rounded-lg ${color} shadow-sm bg-opacity-95 transform-gpu group-hover:scale-105 transition-transform`}>
          {icon}
        </div>
      </div>
    </div>
