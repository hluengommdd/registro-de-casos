  ...
  async function guardarCaso() {
    ...
    try {
      ...
      const casoData = {
        ...
        course_incident: curso,
        conduct_type: tipo,
        conduct_category: categoriasConducta,
        short_description: descripcionLibre,
        responsible: responsableRegistro || 'Usuario Sistema',
        responsible_role: rolResponsable || '',
        status: 'Reportado',
      };
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                  <div>
                    ...
                    <input
                      ...
                      className="w-full rounded-xl border border-slate-300 bg-white text-slate-900 placeholder:text-slate-400 px-4 py-3 text-sm"
                    />
