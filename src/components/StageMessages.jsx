...
export default function StageMessages({
  ...
  return (
    <div className="mt-4 rounded-2xl border border-slate-200 bg-white shadow-sm overflow-hidden flex flex-col max-h-[520px]">
      ...
      {!readOnly && (
        <form onSubmit={handleSubmit} className="border-t border-slate-100 bg-white p-4 space-y-3 sticky bottom-0">
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
            <label className="space-y-1">
              <div className="text-[11px] font-semibold text-slate-600">Nombre</div>
              <input
                value={senderName}
            ...
            <label className="space-y-1">
              <div className="text-[11px] font-semibold text-slate-600">Rol</div>
              <select
                value={senderRole}
          ...
          <div className="flex gap-3 items-end">
            ...
            <button
              ...
              className="px-4 py-2 rounded-full bg-slate-900 text-white text-xs font-bold disabled:opacity-50"
            >
